      ...
      <Card className="w-full max-w-md p-8 gradient-card border-border/50 shadow-glow">
        ...
        <form className="space-y-4">
          <div>
            ...
            <Input id="name" placeholder="আপনার নাম" className="mt-1.5" />
          </div>
          <div>
            <Label htmlFor="email">ইমেইল (Gmail)</Label>
            <Input id="email" type="email" placeholder="you@gmail.com" className="mt-1.5" />
          </div>
          <div>
            <Label htmlFor="phone">ফোন নম্বর</Label>
            <Input id="phone" placeholder="+৮৮০ ১XXX-XXXXXX" className="mt-1.5" />
          </div>
          <div>
          ...
          <Button type="submit" className="w-full gradient-hero text-primary-foreground border-0 shadow-soft hover:shadow-glow transition-all">অ্যাকাউন্ট তৈরি করুন</Button>
        </form>
